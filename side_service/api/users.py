...
@inject
@jwt_required
def search(user_provider: UserProvider) -> dict:
...
@inject
@jwt_required
def create_user(user_provider: UserProvider) -> dict:
...
@inject
@jwt_required
def detail_user(user_provider: UserProvider, username: str) -> dict:
...
@inject
@jwt_required
def update_user(user_provider: UserProvider, username: str) -> dict:
...
@inject
@jwt_required
def delete_user(user_provider: UserProvider, username: int) -> dict:
    pass


@inject
@jwt_required
def update_profile(user_provider: UserProvider) -> dict:
    pass


@inject
@jwt_required
def update_password(user_provider: UserProvider) -> dict:
    pass
